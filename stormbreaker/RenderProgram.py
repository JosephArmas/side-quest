...
class RenderProgram:
    ...
    def render(
        ...
        for o in objects:
            ...
            self.set_uniform("ambientCoe", o.ambient_coe, float)
            self.set_uniform("diffuseCoe", o.diffuse_coe, float)
            self.set_uniform("specularCoe", o.specular_coe, float)
            self.set_uniform("shine", o.shine, float)
            self.set_uniform("cutOff", o.cutOff, float)
            # self.set_uniform("spotDir", o.spotDir, glm.vec3)
